...
function buildRequestBody(input: GeminiScanInput) {
  const prompt = [
    ...
    "Detect clearly visible cooking ingredients, market foods, Vietnamese prepared ingredients, cooked leftovers, international prepared foods, and recognizable packaged food items in this image.",
    "Return JSON only.",
    ...
    "Prepared or cooked food can be a useful scan result too. If a finished dish, leftover portion, or cooked base is recognizable, output the reusable food item with category prepared_food instead of forcing it into a raw ingredient label.",
    "Examples of prepared or cooked foods to recognize when visible: cơm chín, cơm nguội, cơm chiên, gà quay, gà nướng, thịt nướng, cá chiên, rau xào, canh, súp, cà ri, pasta đã nấu, pizza, sandwich, bánh mì nướng, khoai tây chiên, khoai tây nghiền, steak, salad, roast chicken, cooked rice, cooked pasta, fried rice, grilled fish, and grilled meat.",
    ...
    "Also recognize common Western and international grocery items when visible, such as pasta, spaghetti, bread, toast, potato, cheese, butter, cream, milk, yogurt, bacon, sausage, ham, mushroom, spinach, broccoli, bell pepper, zucchini, olive oil, rosemary, thyme, and parsley.",
    ...
    "For leftovers, prefer the most specific visible food name and only add obvious reusable components that are clearly visible beside it.",
